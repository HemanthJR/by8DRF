"""
Django settings for by8labs project.
...
SECRET_KEY = 'django-insecure-v%#)az6v_%xz*cprbyog^2lx+i#&ox3rs8(gv1gwd2477t80$&'
...
WSGI_APPLICATION = 'by8labs.wsgi.application'
